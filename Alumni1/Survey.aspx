...
<asp:Label ID="Label1" runat="server" > <asp:Image ID="Image1"  ImageUrl="~/manipal_joined2.jpg" Height="100%" Width="100%" runat="server"></asp:Image>
 </asp:Label>
 <div class="Form_Back">
     ...
     <asp:Button ID="Button1" runat="server" Text="Submit Form" CssClass="btn"/>
     </div>
</asp:Content>
